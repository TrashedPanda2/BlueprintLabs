...
import AnimatedText from '../../animated-backgrounds/src/AnimatedText';
import LayeredBackground from './LayeredBackground';

// Import new features
import { useAnimationControls } from '../../animated-backgrounds/src/hooks/useAnimationControls';
import { usePerformanceMonitor } from '../../animated-backgrounds/src/hooks/usePerformanceMonitor';
import { createInteractionHandler, GestureRecognizer } from '../../animated-backgrounds/src/utils/interactionUtils';
import { ThemeManager, themeManager, COLOR_SCHEMES, THEMES } from '../../animated-backgrounds/src/utils/themeSystem';
